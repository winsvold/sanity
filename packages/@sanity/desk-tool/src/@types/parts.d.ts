...
declare module 'part:@sanity/components/badges/default' {
  export {default} from '@sanity/base/src/__legacy/components/badges/DefaultBadge'
}

declare module 'part:@sanity/components/buttons/button-grid-style'
declare module 'part:@sanity/components/buttons/button-grid' {
  export {default} from '@sanity/base/src/__legacy/components/buttons/ButtonGrid'
}
...
declare module 'part:@sanity/components/loading/spinner' {
  export {default} from '@sanity/base/src/__legacy/components/loading/Spinner'
}
...
declare module 'part:@sanity/components/menus/default' {
  export * from '@sanity/base/src/__legacy/components/menus/DefaultMenu'
  export {default} from '@sanity/base/src/__legacy/components/menus/DefaultMenu'
}
...
declare module 'part:@sanity/components/panes/default' {
  export {default} from '@sanity/base/src/__legacy/components/panes/DefaultPane'
}
...
declare module 'part:@sanity/components/snackbar/default' {
  export {default} from '@sanity/base/src/__legacy/components/snackbar/DefaultSnackbar'
}

declare module 'part:@sanity/components/tabs/tab' {
  export {default} from '@sanity/base/src/__legacy/components/tabs/Tab'
}

declare module 'part:@sanity/components/tabs/tab-list' {
  export {default} from '@sanity/base/src/__legacy/components/tabs/TabList'
}

declare module 'part:@sanity/components/tabs/tab-panel' {
  export {default} from '@sanity/base/src/__legacy/components/tabs/TabPanel'
}
...
declare module 'part:@sanity/components/typography/hotkeys' {
  export {default} from '@sanity/base/src/__legacy/components/typography/Hotkeys'
}

declare module 'part:@sanity/components/utilities/escapable' {
  export {default} from '@sanity/base/src/__legacy/components/utilities/Escapable'
}

declare module 'part:@sanity/components/validation/list' {
  export {default} from '@sanity/base/src/__legacy/components/validation/ValidationList'
}
